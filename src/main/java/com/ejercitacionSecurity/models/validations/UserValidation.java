package com.ejercitacionSecurity.models.validations;
...
public class UserValidation {
    ...
    public ResponseDTO validate(UserEntity user){
        ...
        if(user.getFirstName() == null || 
            ...
            response.setMessage("El campo firstName no puede ser nulo, y debe tener entre 3 y 15 caracteres");
        }
        ...
        if(user.getLastName() == null || 
           ...
           user.getLastName().length() >30){
            response.setNumOfErrors(response.getNumOfErrors()+1) ;
            response.setMessage("El campo lastName no puede ser nulo, y debe tener entre 3 y 15 caracteres");
        }
